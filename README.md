...
A lightweight `cloud-init` configuration that enables zero-touch, secure registration for Netskope Private Access Publishers in Microsoft Azure. By pasting this script into Azure's Custom data field at launch, the instance automatically verifies basic outbound connectivity and registers itself with your Netskope tenant, eliminating the need to assign a public IP or manually SSH into the box.
